# NB: Non esiste il concetto di MoE
# OSS: è come 'model.py', ma ora tale implementazione è autonoma/più compatta
#      permettendo di ottenere/generare output
...
# Parametri del modello (ricorda: niente moe)
@dataclass
class ModelArgs:
    dim: int
    n_layers: int
...
# Blocco: attenzione + feed forward layer + normalizzazione
