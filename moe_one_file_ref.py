# NB: esiste il concetto di MoE, è quindi più "avanzato"
# rispetto a 'one_file_ref.py' ed è quello che ci interessa.
# Permette di ottenere/generare output
...
# parametri del modello con uso di moe
@dataclass
...
# "classici" parametri del modello
@dataclass
...
# Ripetizione delle chiavi e dei valori del meccansimo di attention
...
# Modifica della forma dei tensori
...
# Applicazione degli embedding rotativi alle query e alle chiavi del meccanismo di attenzione
...
# Meccanismo di attenzione: pesi di ciascun token in base al contesto
...
# normalizzazione RMS (Root Mean Squared Normalization)
...
# Blocco: attenzione (multi-head) + MoE layer + normalizzazione
...
# Coefficienti neessari per gli embedding rotativi
...
# Modello composto da più TransformerBlock
...
# utilizzo del modello per generare testo a partire da prompt speicifici
